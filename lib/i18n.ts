...
const bg: Dict = {
  ...
  'list.empty': 'Списъкът ти е празен.\nНапиши продукт горе или докосни „Често купувани“.',
  ...
  'budget.empty': 'Още няма разходи.\nДобави първия си отгоре.',
  ...
  'cat.empty': 'Още няма категории.\nДобави една отгоре, за да отбелязваш разходите си.',
