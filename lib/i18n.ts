...
const en: Dict = {
  ...
  'budget.overBudget': '{count} over budget',
  'budget.nearingLimit': '{count} nearing limit',
  'budget.none': 'None',
  ...
  'stats.spent': 'SPENT',
  'stats.trend': 'LAST 6 MONTHS',
  'stats.noMonthData': 'No spending this month',
  'stats.prevMonth': 'Previous month',
  'stats.nextMonth': 'Next month',
  'stats.deltaUp': '↑ {pct}% vs previous month',
  'stats.deltaDown': '↓ {pct}% vs previous month',
  'stats.deltaFlat': 'Same as previous month',
  'stats.noBaseline': 'No earlier data to compare',
  ...
  'stats.exportTitle': 'Export transactions',
  'csv.date': 'Date',
...
const bg: Dict = {
  ...
  'budget.overBudget': '{count} над бюджета',
  'budget.nearingLimit': '{count} близо до лимита',
  'budget.none': 'Няма',
  ...
  'stats.spent': 'ПОХАРЧЕНО',
  'stats.trend': 'ПОСЛЕДНИ 6 МЕСЕЦА',
  'stats.noMonthData': 'Няма разходи този месец',
  'stats.prevMonth': 'Предходен месец',
  'stats.nextMonth': 'Следващ месец',
  'stats.deltaUp': '↑ {pct}% спрямо предходния месец',
  'stats.deltaDown': '↓ {pct}% спрямо предходния месец',
  'stats.deltaFlat': 'Колкото предходния месец',
  'stats.noBaseline': 'Няма по-ранни данни за сравнение',
  ...
  'stats.bought': 'Купени',
  'stats.exportCsv': 'Експорт в CSV',
  'stats.exportTitle': 'Експорт на транзакции',
  'csv.date': 'Дата',
  'csv.description': 'Описание',
